...
export class RegistroamigosService {
  presURL = 'https://proyectogamerface-9e004-default-rtdb.firebaseio.com//notificaciones';
  presURL1 = 'https://proyectogamerface-9e004-default-rtdb.firebaseio.com//amigos.json';
